 ...
 */
      ...
      // Keeps a mapping stream.id => [stream, rtpsenders...]
        ...
        window.RTCPeerConnection.prototype.addTrack = function addTrack (track, stream) {
          ...
          } else if (!this._shimmedLocalStreams[stream.id].includes(sender)) {
        ...
        window.RTCPeerConnection.prototype.addStream = function addStream (stream) {
          ...
          const newSenders = this.getSenders().filter(function (newSender) {
            return !existingSenders.includes(newSender)
          })
      ...
      function shimPeerConnection (window) {
        ...
        const addIceCandidateNullSupported = window.RTCPeerConnection.prototype.addIceCandidate.length === 0
      ...
      function shimMaxMessageSize (window) {
        ...
        const sctpInDescription = function sctpInDescription (description) {
          ...
          return sections.some(function (mediaSection) {
            ...
            return mLine && mLine.kind === 'application' && mLine.protocol.includes('SCTP')
          })
        }
 ...
 */
      ...
      /* remove a=extmap-allow-mixed for Chrome < M71 */
        ...
        window.RTCPeerConnection.prototype.setRemoteDescription = function setRemoteDescription (desc) {
          if (desc && desc.sdp && desc.sdp.includes('\na=extmap-allow-mixed')) {
 ...
 */
      ...
      function isActionAllowedInSignalingState (action, type, signalingState) {
        ...
        }[type][action].includes(signalingState)
      }
      ...
      // dispatch the event ourselves.
        ...
        RTCPeerConnection.prototype.removeTrack = function (sender) {
          ...
          if (!localStreams.includes(stream) &&
        this.localStreams.includes(stream)) {
    ...
    (keyParams.mkiValue && keyParams.mkiLength
      ...
      SDPUtils.parseRtpEncodingParameters = function (mediaSection) {
        ...
        const hasRed = description.fecMechanisms.includes('RED')
        const hasUlpfec = description.fecMechanisms.includes('ULPFEC')
